...
@interface LRGetDocumentListService ()
...
@implementation LRGetDocumentListService
...
- (void)getDocument:(LRGetDocumentResponse)responseBlock withDocumentType:(NSString *)documentType andId:(int )documentTypeId
{
    ...
    [theRequest addValue: @"http://tempuri.org/IIIRPIOSService/GetDocumentList" forHTTPHeaderField:@"Soapaction"];
