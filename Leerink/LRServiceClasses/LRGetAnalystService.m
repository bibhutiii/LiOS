...
@implementation LRGetAnalystService
...
{
    __block BOOL isAnalystFetched = TRUE;
    ...
    NSString *soapMessage = [NSString stringWithFormat:
                             ...
                             "<SOAP-ENV:Body> \n"
                             "<GetAnalysts xmlns=\"http://tempuri.org/\">"
                             "</GetAnalysts>\n"
                             "</SOAP-ENV:Body> \n"
                             "</SOAP-ENV:Envelope>"];
    ...
    if (theConnection) {
        ...
        isAnalystFetched = FALSE;
        NSLog(@"No Connection established");
    }
    responseBlock(isAnalystFetched);
}
#pragma mark - new
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qualifiedName attributes:(NSDictionary *)attributeDict
{
	...
	if([elementName isEqualToString:@"GetAnalystsResult"])
    {
